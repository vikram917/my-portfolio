  ...
  return (
    <div className="flex flex-col md:flex-row h-full text-sm">
      ...
      <div className=" w-full md:w-3/5 md:h-full text-slate-300">
        <div>
          <h3 className="text-lg md:text-4xl font-bold mb-2 mt-2 md:mb-4">
            Qualifications
          </h3>
          <hr />
        ...
        <div className="md:space-y-6">
          <h1 className="text-lg md:text-4xl font-bold mb-2 mt-2 md:mb-4 md:mt-8">
            Skill's
          </h1>
          <hr />
...
{/* <div>
              ...
              <div>
                <img
                  src="/html.png"
                  alt=""
                  className="md:w-16 transform hover:translate-x-[-5px] transition duration-300 ease-in-out"
                />
              </div>
              <div>
                <img
                  src="/css.png"
                  alt=""
                  className="md:w-20 transform hover:translate-x-[-5px] transition duration-300 ease-in-out"
                />
              </div>
              <div>
                <img
